...
void configuracoesDoJogo()
{
    ...
    do{
        ...
        do{
            ...
            switch(z)
            {
                case 7 : Bombas=(((float)Linha*(float)Coluna)/100.0)*10+1;
                    strcpy(dif, "Facil");break;
                case 8 : Bombas=(((float)Linha*(float)Coluna)/100.0)*15+1;
                    strcpy(dif, "Medio");break;
                case 9 : Bombas=(((float)Linha*(float)Coluna)/100.0)*20+1;
                    strcpy(dif, "Dificil");break;
                case 10 : Bombas=(((float)Linha*(float)Coluna)/100.0)*40+1;
