...
void MostrarRank()
{
    ...
    printf("RANKING\n");
    gotoxy(51, 14);
    printf(" \tPosicao\t  Nome\tPontos\tDificuldade\tTamanho\n\n");
    for(x=0;x<10;x++)
    {
        tabulacaoBonitinha(6,0);
...
void configuracoesDoJogo() {
    ...
    do {
        ...
        tabulacaoBonitinha(6, 0);
        printf("%c Use as SETAS do teclado para navegar pelas opcoes.\n",186);
        tabulacaoBonitinha(6, 0);
...
void Sair() { //procedimento de saída do jogo e créditos
    limpaTela();
    printf("\n\n\tSaindo...\n\n\n\n\n\n\n\n\n\t");
    printf("\n\n\tDesenvolvido por Lucas Vanjura,\n\n");
